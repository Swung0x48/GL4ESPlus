...
void APIENTRY_GL4ES gl4es_glMemoryBarrier(GLbitfield barriers) {
    DBG(printf("glMemoryBarrier(0x%x)\n", barriers);)
...
GLsync APIENTRY_GL4ES gl4es_glFenceSync(GLenum condition, GLbitfield flags) {
    DBG(printf("glFenceSync(%s, 0x%x)\n", PrintEnum(condition), flags);)

}
AliasExport(GLsync,glFenceSync,,(GLenum condition, GLbitfield flags));

void APIENTRY_GL4ES gl4es_glDeleteSync(GLsync sync) {
    DBG(printf("glDeleteSync(%d)\n", sync);)

}
AliasExport(void,glDeleteSync,,(GLsync sync));

GLenum APIENTRY_GL4ES gl4es_glClientWaitSync(GLsync sync, GLbitfield flags, GLuint64 timeout) {
    DBG(printf("glClientWaitSync(%d, 0x%x, %d)\n", sync, flags, timeout);)

}
AliasExport(GLenum,glClientWaitSync,,(GLsync sync, GLbitfield flags, GLuint64 timeout));
