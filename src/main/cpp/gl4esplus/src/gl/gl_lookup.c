...
void* APIENTRY_GL4ES gl4es_GetProcAddress(const char *name) {
    ...
    //STUB(glGetStringi);
    //STUB(glClearBufferiv);
    //STUB(glClearBufferuiv);
    //STUB(glClearBufferfv);
    //STUB(glClearBufferfi);
    STUB(glVertexAttribI1i);
    STUB(glVertexAttribI2i);
    STUB(glVertexAttribI3i);
    STUB(glVertexAttribI4i);
    STUB(glVertexAttribI1ui);
    STUB(glVertexAttribI2ui);
    STUB(glVertexAttribI3ui);
    STUB(glVertexAttribI4ui);
    STUB(glVertexAttribI1iv);
    STUB(glVertexAttribI2iv);
    STUB(glVertexAttribI3iv);
    STUB(glVertexAttribI4iv);
    STUB(glVertexAttribI1uiv);
    STUB(glVertexAttribI2uiv);
    STUB(glVertexAttribI3uiv);
    STUB(glVertexAttribI4uiv);
    STUB(glVertexAttribI4bv);
    STUB(glVertexAttribI4sv);
    STUB(glVertexAttribI4ubv);
    STUB(glVertexAttribI4usv);
    //STUB(glVertexAttribIPointer);
    STUB(glGetVertexAttribIiv);
    STUB(glGetVertexAttribIuiv);
    STUB(glUniform1ui);
    STUB(glUniform2ui);
    STUB(glUniform3ui);
    STUB(glUniform4ui);
    ...
    STUB(glUniform3uiv);
    STUB(glUniform4uiv);
    STUB(glGetUniformuiv);
    //STUB(glBindFragDataLocation);
    STUB(glGetFragDataLocation);
    STUB(glBeginConditionalRender);
    STUB(glEndConditionalRender);
    //STUB(glMapBufferRange);
    //STUB(glFlushMappedBufferRange);
    //STUB(glClampColor);
    //STUB(glIsRenderbuffer);
    //STUB(glBindRenderbuffer);
    //STUB(glDeleteRenderbuffers);
    //STUB(glGenRenderbuffers);
    //STUB(glRenderbufferStorage);
    //STUB(glRenderbufferStorageMultisample);
    //STUB(glGetRenderbufferParameteriv);
    //STUB(glIsFramebuffer);
    //STUB(glBindFramebuffer);
    //STUB(glDeleteFramebuffers);
    //STUB(glGenFramebuffers);
    //STUB(glCheckFramebufferStatus);
    //STUB(glFramebufferTexture1D);
    //STUB(glFramebufferTexture2D);
    //STUB(glFramebufferTexture3D);
    //STUB(glFramebufferTextureLayer);
    //STUB(glFramebufferRenderbuffer);
    //STUB(glGetFramebufferAttachmentParameteriv);
    //STUB(glBlitFramebuffer);
    //STUB(glGenerateMipmap);
    STUB(glTexParameterIiv);
    STUB(glTexParameterIuiv);
    STUB(glGetTexParameterIiv);
    STUB(glGetTexParameterIuiv);
    STUB(glColorMaski);
    STUB(glGetBooleani_v);
    STUB(glGetIntegeri_v);
    STUB(glEnablei);
    STUB(glDisablei);
    STUB(glIsEnabledi);
    STUB(glBindBufferRange);
    //STUB(glBindBufferBase);
    STUB(glBeginTransformFeedback);
    STUB(glEndTransformFeedback);
    STUB(glTransformFeedbackVaryings);
    STUB(glGetTransformFeedbackVarying);
    //STUB(glBindVertexArray);
    //STUB(glDeleteVertexArrays);
    //STUB(glGenVertexArrays);
    //STUB(glIsVertexArray);

    // ================================ GL31 ================================

    //STUB(glDrawArraysInstanced);
    //STUB(glDrawElementsInstanced);
    //STUB(glCopyBufferSubData);
    STUB(glPrimitiveRestartIndex);
    STUB(glTexBuffer);
    STUB(glGetUniformIndices);
    STUB(glGetActiveUniformsiv);
    STUB(glGetActiveUniformName);
    STUB(glGetUniformBlockIndex);
    STUB(glGetActiveUniformBlockiv);
    STUB(glGetActiveUniformBlockName);
    STUB(glUniformBlockBinding);

    // ================================ GL32 ================================

    STUB(glGetBufferParameteri64v);
    //STUB(glDrawElementsBaseVertex);
    //STUB(glDrawRangeElementsBaseVertex);
    //STUB(glDrawElementsInstancedBaseVertex);
    //STUB(glMultiDrawElementsBaseVertex);
    STUB(glProvokingVertex);
    STUB(glTexImage2DMultisample);
    STUB(glTexImage3DMultisample);
    STUB(glGetMultisamplefv);
    STUB(glSampleMaski);
    STUB(glFramebufferTexture);
    //STUB(glFenceSync);
    STUB(glIsSync);
    //STUB(glDeleteSync);
    //STUB(glClientWaitSync);
    STUB(glWaitSync);
    STUB(glGetInteger64v);
    STUB(glGetInteger64i_v);
    STUB(glGetSynciv);
    ...
    STUB(glTexCoordP3ui);
    STUB(glTexCoordP4ui);
    STUB(glTexCoordP1uiv);
    STUB(glTexCoordP2uiv);
    STUB(glTexCoordP3uiv);
    STUB(glTexCoordP4uiv);
    STUB(glMultiTexCoordP1ui);
    STUB(glMultiTexCoordP2ui);
    STUB(glMultiTexCoordP3ui);
    STUB(glMultiTexCoordP4ui);
    STUB(glMultiTexCoordP1uiv);
    STUB(glMultiTexCoordP2uiv);
    STUB(glMultiTexCoordP3uiv);
    STUB(glMultiTexCoordP4uiv);
    STUB(glNormalP3ui);
    STUB(glNormalP3uiv);
    STUB(glColorP3ui);
    STUB(glColorP4ui);
    STUB(glColorP3uiv);
    STUB(glColorP4uiv);
    STUB(glSecondaryColorP3ui);
    STUB(glSecondaryColorP3uiv);
    STUB(glBindFragDataLocationIndexed);
    STUB(glGetFragDataIndex);
    //STUB(glGenSamplers);
    //STUB(glDeleteSamplers);
    //STUB(glIsSampler);
    //STUB(glBindSampler);
    //STUB(glSamplerParameteri);
    //STUB(glSamplerParameterf);
    //STUB(glSamplerParameteriv);
    //STUB(glSamplerParameterfv);
    //STUB(glSamplerParameterIiv);
    //STUB(glSamplerParameterIuiv);
    //STUB(glGetSamplerParameteriv);
    //STUB(glGetSamplerParameterfv);
    //STUB(glGetSamplerParameterIiv);
    //STUB(glGetSamplerParameterIuiv);
    //STUB(glQueryCounter);
    //STUB(glGetQueryObjecti64v);
    //STUB(glGetQueryObjectui64v);
    //STUB(glVertexAttribDivisor);
    STUB(glVertexAttribP1ui);
    STUB(glVertexAttribP2ui);
    STUB(glVertexAttribP3ui);
    STUB(glVertexAttribP4ui);
    STUB(glVertexAttribP1uiv);
    STUB(glVertexAttribP2uiv);
    STUB(glVertexAttribP3uiv);
    STUB(glVertexAttribP4uiv);

    // ================================ GL40 ================================

    STUB(glBlendEquationi);
    //STUB(BlendEquationSeparatei);
    STUB(glBlendFunci);
    //STUB(BlendFuncSeparatei);
    STUB(glDrawArraysIndirect);
    STUB(glDrawElementsIndirect);
    STUB(glUniform1d);
    STUB(glUniform2d);
    STUB(glUniform3d);
    STUB(glUniform4d);
    ...
    STUB(glUniform3dv);
    STUB(glUniform4dv);
    STUB(glUniformMatrix2dv);
    STUB(glUniformMatrix3dv);
    STUB(glUniformMatrix4dv);
    STUB(glUniformMatrix2x3dv);
    STUB(glUniformMatrix2x4dv);
    STUB(glUniformMatrix3x2dv);
    STUB(glUniformMatrix3x4dv);
    STUB(glUniformMatrix4x2dv);
    STUB(glUniformMatrix4x3dv);
    STUB(glGetUniformdv);
    STUB(glMinSampleShading);
    STUB(glGetSubroutineUniformLocation);
    STUB(glGetSubroutineIndex);
    STUB(glGetActiveSubroutineUniformiv);
    STUB(glGetActiveSubroutineUniformName);
    STUB(glGetActiveSubroutineName);
    STUB(glUniformSubroutinesuiv);
    STUB(glGetUniformSubroutineuiv);
    STUB(glGetProgramStageiv);
    STUB(glPatchParameteri);
    STUB(glPatchParameterfv);
    STUB(glBindTransformFeedback);
    STUB(glDeleteTransformFeedbacks);
    STUB(glGenTransformFeedbacks);
    STUB(glIsTransformFeedback);
    STUB(glPauseTransformFeedback);
    STUB(glResumeTransformFeedback);
    STUB(glDrawTransformFeedback);
    STUB(glDrawTransformFeedbackStream);
    STUB(glBeginQueryIndexed);
    STUB(glEndQueryIndexed);
    STUB_U(glGetQueryIndexedi);
    STUB(glGetQueryIndexediv);

    // ================================ GL41 ================================

    //STUB(glReleaseShaderCompiler);
    //STUB(glShaderBinary);
    //STUB(glGetShaderPrecisionFormat);
    //STUB(glDepthRangef);
    //STUB(glClearDepthf);
    //STUB(glGetProgramBinary);
    //STUB(glProgramBinary);
    STUB(glProgramParameteri);
    STUB(glUseProgramStages);
    STUB(glActiveShaderProgram);
    STUB(glCreateShaderProgramv);
    STUB(glBindProgramPipeline);
    STUB(glDeleteProgramPipelines);
    STUB(glGenProgramPipelines);
    STUB(glIsProgramPipeline);
    STUB(glGetProgramPipelineiv);
    //STUB(glProgramUniform1i);
    //STUB(glProgramUniform2i);
    //STUB(glProgramUniform3i);
    //STUB(glProgramUniform4i);
    STUB(glProgramUniform1ui);
    STUB(glProgramUniform2ui);
    STUB(glProgramUniform3ui);
    STUB(glProgramUniform4ui);
    //STUB(glProgramUniform1f);
    //STUB(glProgramUniform2f);
    //STUB(glProgramUniform3f);
    //STUB(glProgramUniform4f);
    STUB(glProgramUniform1d);
    STUB(glProgramUniform2d);
    STUB(glProgramUniform3d);
    STUB(glProgramUniform4d);
    //STUB(glProgramUniform1iv);
    //STUB(glProgramUniform2iv);
    //STUB(glProgramUniform3iv);
    //STUB(glProgramUniform4iv);
    STUB(glProgramUniform1uiv);
    STUB(glProgramUniform2uiv);
    STUB(glProgramUniform3uiv);
    STUB(glProgramUniform4uiv);
    //STUB(glProgramUniform1fv);
    //STUB(glProgramUniform2fv);
    //STUB(glProgramUniform3fv);
    //STUB(glProgramUniform4fv);
    STUB(glProgramUniform1dv);
    STUB(glProgramUniform2dv);
    STUB(glProgramUniform3dv);
    STUB(glProgramUniform4dv);
    //STUB(glProgramUniformMatrix2fv);
    //STUB(glProgramUniformMatrix3fv);
    //STUB(glProgramUniformMatrix4fv);
    STUB(glProgramUniformMatrix2dv);
    STUB(glProgramUniformMatrix3dv);
    STUB(glProgramUniformMatrix4dv);
    STUB(glProgramUniformMatrix2x3fv);
    STUB(glProgramUniformMatrix3x2fv);
    STUB(glProgramUniformMatrix2x4fv);
    STUB(glProgramUniformMatrix4x2fv);
    STUB(glProgramUniformMatrix3x4fv);
    STUB(glProgramUniformMatrix4x3fv);
    STUB(glProgramUniformMatrix2x3dv);
    STUB(glProgramUniformMatrix3x2dv);
    STUB(glProgramUniformMatrix2x4dv);
    STUB(glProgramUniformMatrix4x2dv);
    STUB(glProgramUniformMatrix3x4dv);
    STUB(glProgramUniformMatrix4x3dv);
    STUB(glValidateProgramPipeline);
    STUB(glGetProgramPipelineInfoLog);
    STUB(glVertexAttribL1d);
    STUB(glVertexAttribL2d);
    STUB(glVertexAttribL3d);
    STUB(glVertexAttribL4d);
    STUB(glVertexAttribL1dv);
    STUB(glVertexAttribL2dv);
    STUB(glVertexAttribL3dv);
    STUB(glVertexAttribL4dv);
    STUB(glVertexAttribLPointer);
    STUB(glGetVertexAttribLdv);
    STUB(glViewportArrayv);
    STUB(glViewportIndexedf);
    STUB(glViewportIndexedfv);
    STUB(glScissorArrayv);
    STUB(glScissorIndexed);
    STUB(glScissorIndexedv);
    STUB(glDepthRangeArrayv);
    ...
    STUB(glGetActiveAtomicCounterBufferiv);
    //STUB(glTexStorage1D);
    //STUB(glTexStorage2D);
    //STUB(glTexStorage3D);
    STUB(glDrawTransformFeedbackInstanced);
    STUB(glDrawTransformFeedbackStreamInstanced);
    STUB(glDrawArraysInstancedBaseInstance);
    STUB(glDrawElementsInstancedBaseInstance);
    STUB(glDrawElementsInstancedBaseVertexBaseInstance);
    STUB(glBindImageTexture);
    //STUB(glMemoryBarrier);
    STUB(glGetInternalformativ);

    // ================================ GL43 ================================

    STUB(glClearBufferData);
    STUB(glClearBufferSubData);
    STUB(glDispatchCompute);
    STUB(glDispatchComputeIndirect);
    //STUB(glCopyImageSubData);
    STUB(glDebugMessageControl);
    STUB(glDebugMessageInsert);
    STUB(glDebugMessageCallback);
    STUB(glGetDebugMessageLog);
    STUB(glPushDebugGroup);
    STUB(glPopDebugGroup);
    STUB(glObjectLabel);
    STUB(glGetObjectLabel);
    STUB(glObjectPtrLabel);
    STUB(glGetObjectPtrLabel);
    STUB(glFramebufferParameteri);
    STUB(glGetFramebufferParameteriv);
    STUB(glGetInternalformati64v);
    STUB(glInvalidateTexSubImage);
    STUB(glInvalidateTexImage);
    STUB(glInvalidateBufferSubData);
    STUB(glInvalidateBufferData);
    STUB(glInvalidateFramebuffer);
    STUB(glInvalidateSubFramebuffer);
    STUB(glMultiDrawArraysIndirect);
    STUB(glMultiDrawElementsIndirect);
    STUB(glGetProgramInterfaceiv);
    STUB(glGetProgramResourceIndex);
    STUB(glGetProgramResourceName);
    STUB(glGetProgramResourceiv);
    STUB(glGetProgramResourceLocation);
    STUB(glGetProgramResourceLocationIndex);
    STUB(glShaderStorageBlockBinding);
    STUB(glTexBufferRange);
    STUB(glTexStorage2DMultisample);
    STUB(glTexStorage3DMultisample);
    STUB(glTextureView);
    STUB(glBindVertexBuffer);
    STUB(glVertexAttribFormat);
    STUB(glVertexAttribIFormat);
    STUB(glVertexAttribLFormat);
    STUB(glVertexAttribBinding);
    STUB(glVertexBindingDivisor);

    // ================================ GL44 ================================

    //STUB(glBufferStorage);
    STUB(glClearTexSubImage);
    STUB(glClearTexImage);
    STUB(glBindBuffersBase);
    STUB(glBindBuffersRange);
    STUB(glBindTextures);
    STUB(glBindSamplers);
    STUB(glBindImageTextures);
    STUB(glBindVertexBuffers);

    // ================================ GL45 ================================

    /*STUB(glClipControl);
    STUB(glCreateTransformFeedbacks);
    STUB(glTransformFeedbackBufferBase);
    STUB(glTransformFeedbackBufferRange);
    STUB(glGetTransformFeedbackiv);
    STUB(glGetTransformFeedbacki_v);
    STUB(glGetTransformFeedbacki64_v);
    STUB(glCreateBuffers);
    STUB(glNamedBufferStorage);
    //STUB(glNamedBufferData);
    //STUB(glNamedBufferSubData);
    STUB(glCopyNamedBufferSubData);
    STUB(glClearNamedBufferData);
    STUB(glClearNamedBufferSubData);
    //STUB(glMapNamedBuffer);
    STUB(glMapNamedBufferRange);
    //STUB(glUnmapNamedBuffer);
    STUB(glFlushMappedNamedBufferRange);
    //STUB(glGetNamedBufferParameteriv);
    STUB(glGetNamedBufferParameteri64v);
    //STUB(glGetNamedBufferPointerv);
    //STUB(glGetNamedBufferSubData);
    STUB(glCreateFramebuffers);
    STUB(glNamedFramebufferRenderbuffer);
    STUB(glNamedFramebufferParameteri);
    STUB(glNamedFramebufferTexture);
    STUB(glNamedFramebufferTextureLayer);
    STUB(glNamedFramebufferDrawBuffer);
    //STUB(glNamedFramebufferDrawBuffers);
    STUB(glNamedFramebufferReadBuffer);
    STUB(glInvalidateNamedFramebufferData);
    STUB(glInvalidateNamedFramebufferSubData);
    //STUB(glClearNamedFramebufferiv);
    //STUB(glClearNamedFramebufferuiv);
    //STUB(glClearNamedFramebufferfv);
    //STUB(glClearNamedFramebufferfi);
    STUB(glBlitNamedFramebuffer);
    STUB(glCheckNamedFramebufferStatus);
    STUB(glGetNamedFramebufferParameteriv);
    STUB(glGetNamedFramebufferAttachmentParameteriv);
    STUB(glCreateRenderbuffers);
    STUB(glNamedRenderbufferStorage);
    STUB(glNamedRenderbufferStorageMultisample);
    STUB(glGetNamedRenderbufferParameteriv);
    STUB(glCreateTextures);
    STUB(glTextureBuffer);
    STUB(glTextureBufferRange);
    STUB(glTextureStorage1D);
    STUB(glTextureStorage2D);
    STUB(glTextureStorage3D);
    STUB(glTextureStorage2DMultisample);
    STUB(glTextureStorage3DMultisample);
    //STUB(glTextureSubImage1D);
    //STUB(glTextureSubImage2D);
    //STUB(glTextureSubImage3D);
    //STUB(glCompressedTextureSubImage1D);
    //STUB(glCompressedTextureSubImage2D);
    //STUB(glCompressedTextureSubImage3D);
    //STUB(glCopyTextureSubImage1D);
    //STUB(glCopyTextureSubImage2D);
    //STUB(glCopyTextureSubImage3D);
    //STUB(glTextureParameterf);
    //STUB(glTextureParameterfv);
    //STUB(glTextureParameteri);
    STUB(glTextureParameterIiv);
    STUB(glTextureParameterIuiv);
    //STUB(glTextureParameteriv);
    STUB(glGenerateTextureMipmap);
    STUB(glBindTextureUnit);
    //STUB(glGetTextureImage);
    //STUB(glGetCompressedTextureImage);
    //STUB(glGetTextureLevelParameterfv);
    //STUB(glGetTextureLevelParameteriv);
    //STUB(glGetTextureParameterfv);
    STUB(glGetTextureParameterIiv);
    STUB(glGetTextureParameterIuiv);
    //STUB(glGetTextureParameteriv);
    STUB(glCreateVertexArrays);
    //STUB(glDisableVertexArrayAttrib);
    //STUB(glEnableVertexArrayAttrib);
    STUB(glVertexArrayElementBuffer);
    STUB(glVertexArrayVertexBuffer);
    STUB(glVertexArrayVertexBuffers);
    STUB(glVertexArrayAttribFormat);
    STUB(glVertexArrayAttribIFormat);
    STUB(glVertexArrayAttribLFormat);
    STUB(glVertexArrayAttribBinding);
    STUB(glVertexArrayBindingDivisor);
    STUB(glGetVertexArrayiv);
    STUB(glGetVertexArrayIndexediv);
    STUB(glGetVertexArrayIndexed64iv);
    STUB(glCreateSamplers);
    STUB(glCreateProgramPipelines);
    STUB(glCreateQueries);
    STUB(glGetQueryBufferObjectiv);
    STUB(glGetQueryBufferObjectuiv);
    STUB(glGetQueryBufferObjecti64v);
    STUB(glGetQueryBufferObjectui64v);
    STUB(glMemoryBarrierByRegion);
    STUB(glGetTextureSubImage);
    STUB(glGetCompressedTextureSubImage);
    STUB(glTextureBarrier);
    STUB(glGetGraphicsResetStatus);
    STUB(glReadnPixels);
    STUB(glGetnUniformfv);
    STUB(glGetnUniformiv);
    STUB(glGetnUniformuiv);

    // ================================ GL46 ================================

    STUB(glMultiDrawArraysIndirectCount);
    STUB(glMultiDrawElementsIndirectCount);
    STUB(glPolygonOffsetClamp);
    STUB(glSpecializeShader);*/



    // ================================ GL4ES PLUS ================================

    _EX(glBindFragDataLocation);
    _EX(glBindBufferBase);
    _EX(glBufferStorage);
    _EX(glCopyImageSubData);
    _EX(glMemoryBarrier);
    _EX(glFenceSync);
    _EX(glDeleteSync);
    _EX(glClientWaitSync);
    ...
    if(hardext.fbo) {
        ...
        _EX(glClearBufferfv);
        _EX(glClearBufferfi);
        _EX(glNamedFramebufferDrawBuffers);
    ...
    STUB_U(glUniformMatrix2x3fv);
    STUB_U(glUniformMatrix3x2fv);
    STUB_U(glUniformMatrix2x4fv);
    STUB_U(glUniformMatrix4x2fv);
    STUB_U(glUniformMatrix3x4fv);
    STUB_U(glUniformMatrix4x3fv);
