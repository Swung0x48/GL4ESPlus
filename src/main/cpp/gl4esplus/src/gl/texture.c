...
void APIENTRY_GL4ES gl4es_glCopyImageSubData(GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei srcWidth, GLsizei srcHeight, GLsizei srcDepth) {
    DBG(printf("glCopyImageSubData(%d, %s, %d, %d, %d, %d, %d, %s, %d, %d, %d, %d, %i, %i, %i)\n", srcName, PrintEnum(srcTarget), srcLevel, srcX, srcY, srcZ,
               dstName, PrintEnum(srcTarget), dstLevel, dstX, dstY, dstZ,
               srcWidth, srcHeight, srcDepth);)
    LOAD_GLES(glCopyImageSubData)


    gltexture_t* srcTex = gl4es_getTexture(GL_TEXTURE_2D, srcName);
    gltexture_t* dstTex = gl4es_getTexture(GL_TEXTURE_2D, dstName);

    GLuint srcId = srcTex->glname;
    GLuint dstId = dstTex->glname;

    gles_glCopyImageSubData(srcId, srcTarget, srcLevel, srcX, srcY, srcZ,
                            dstId, srcTarget, dstLevel, dstX, dstY, dstZ,
                            srcWidth, srcHeight, srcDepth);
}
...
//GL43
AliasExport(void,glCopyImageSubData,,(GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei srcWidth, GLsizei srcHeight, GLsizei srcDepth));
