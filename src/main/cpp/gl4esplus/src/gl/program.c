...
void gl4es_glBindFragDataLocation(GLuint program, GLuint colorNumber, const GLchar *name) {
...
void APIENTRY_GL4ES gl4es_glLinkProgram(GLuint program) {
    ...
    if(glprogram->last_vert) {
        ...
        // check if glBindFragDataLocation is used
...
AliasExport(void, glBindFragDataLocation,,(GLuint program, GLuint colorNumber, const GLchar *name));
