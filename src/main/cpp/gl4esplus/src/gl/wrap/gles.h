...
typedef void (APIENTRY_GLES * glDrawElementsBaseVertex_PTR)(GLenum mode, GLsizei count, GLenum type, const void *indices, GLint basevertex);

typedef void (APIENTRY_GLES * glReadBuffer_PTR)(GLenum mode);

typedef void (APIENTRY_GLES * glBindBufferBase_PTR)(GLenum target, GLuint index, GLuint buffer);

typedef void (APIENTRY_GLES * glCopyImageSubData_PTR)(GLuint srcName,
                                                      GLenum srcTarget,
                                                      GLint srcLevel,
                                                      GLint srcX,
                                                      GLint srcY,
