...
void APIENTRY_GL4ES glBindBufferBase(GLenum target, GLuint index, GLuint buffer);
void APIENTRY_GL4ES glBufferStorage(GLenum target, GLsizeiptr size, const GLvoid * data, GLbitfield flags);
...
void APIENTRY_GL4ES glReadBuffer(GLenum mode);
